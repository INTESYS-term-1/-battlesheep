...
//											if (k != i && j != l) {
//												tempState = new State(this.board, this, player, level + 1);
...
//									}
								...
								// int o = j - 1;
								// for (int n = i + 1; n < Gui.BOARDCOLUMN || o
								// >1; n++) {
								// if (board[n + 1][o - 1].getOwner() != free) {
								// for (int m = 1; m < board[i][j].getValue();
								// m++) {
								// tempState = new State(this.board, this,
								// player, level + 1);
								// tempState.getBoard()[n][o].setOwner(ai);
								// tempState.getBoard()[n][o].setValue(m);
								// tempState.getBoard()[i][j].setValue(board[i][j].getValue()
								// - 1 - m);
								//
								// states.add(tempState);
								//
		...
		System.out.println("Done sa loop");
